...
RSpec.describe Git::Cop::Styles::CommitBodyBulletDelimiter do
  ...
  describe "#valid?" do
    context "with space after bullet" do
      ...
      it "answers true" do
        expect(commit_body_bullet_delimiter_style.valid?).to eq(true)
      end
    end
    ...
    context "without space after bullet" do
      ...
      it "answers false" do
        expect(commit_body_bullet_delimiter_style.valid?).to eq(false)
      end
    end
  ...
  describe "#issue" do
    let(:issue) { commit_body_bullet_delimiter_style.issue }
